...
<!-- Block: Homepage Hero -->
<div class="home-hero">
  <img class="home-hero__mask home-hero__mask--desktop" src="<?php echo get_template_directory_uri(); ?>/assets/images/masks/arrow-mask-desktop.svg" />
  <img class="home-hero__mask home-hero__mask--mobile" src="<?php echo get_template_directory_uri(); ?>/assets/images/masks/arrow-mask-mobile.svg" />
